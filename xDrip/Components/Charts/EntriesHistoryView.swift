...
final class EntriesHistoryView: UIView {
    ...
    private let chartView = EntriesChartView()
    //    private let chartSliderView = UIView()
    ...
    private func setupViews() {
        ...
        //        chartSliderView.translatesAutoresizingMaskIntoConstraints = false
