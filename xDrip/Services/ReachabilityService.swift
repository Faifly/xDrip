...
//  xDrip
//
//  Created by Ivan Skoryk on 27.07.2020.
...
public class ReachabilityService {
    public typealias NetworkReachable = (ReachabilityService) -> Void
    public typealias NetworkUnreachable = (ReachabilityService) -> Void
    ...
    required init(reachabilityRef: SCNetworkReachability,
        ...
        self.reachabilitySerialQueue = DispatchQueue(
            label: "com.faifly.xDrip.reachability",
            qos: queueQoS,
            target: targetQueue
        )
...
public extension ReachabilityService {
    ...
    func startNotifier() throws {
        ...
        let opaqueWeakified = Unmanaged<ReachabilityWeakifier>.passUnretained(weakifiedReachability).toOpaque()

        var context = SCNetworkReachabilityContext(
            version: 0,
            info: UnsafeMutableRawPointer(opaqueWeakified),
...
fileprivate extension ReachabilityService {
...
extension SCNetworkReachabilityFlags {
    typealias Connection = ReachabilityService.Connection
