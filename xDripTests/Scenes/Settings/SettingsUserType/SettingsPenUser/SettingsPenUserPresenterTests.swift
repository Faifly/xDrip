//
//  SettingsPenUserPresenterTests.swift
//  xDrip
//
...
final class SettingsPenUserPresenterTests: XCTestCase {
    // MARK: Subject under test
    
    var sut: SettingsPenUserPresenter!
    
    // MARK: Test lifecycle
    
    override func setUp() {
        super.setUp()
        setupSettingsPenUserPresenter()
    }
    ...
    func setupSettingsPenUserPresenter() {
        sut = SettingsPenUserPresenter()
    }
