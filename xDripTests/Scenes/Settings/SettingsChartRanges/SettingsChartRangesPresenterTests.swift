//
//  SettingsChartRangesPresenterTests.swift
//  xDrip
//
...
final class SettingsChartRangesPresenterTests: XCTestCase {
    // MARK: Subject under test
    
    var sut: SettingsChartRangesPresenter!
    
    // MARK: Test lifecycle
    
    override func setUp() {
        super.setUp()
        setupSettingsChartRangesPresenter()
    }
    ...
    func setupSettingsChartRangesPresenter() {
        sut = SettingsChartRangesPresenter()
    }
